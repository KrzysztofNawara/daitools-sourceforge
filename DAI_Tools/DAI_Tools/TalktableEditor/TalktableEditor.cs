...
namespace DAI_Tools.TalktableEditor
{
    public partial class TalktableEditor : Form
    {
        ...
        public void Save(string path)
        {
            ...
            Tools.WriteInt(fs, (int)talk.magic);                        //0
            Tools.WriteInt(fs, (int)talk.unk01);
            Tools.WriteInt(fs, 0x38 + NodeList.Count * 4 + StringList.Count * 8);
            Tools.WriteInt(fs, (int)talk.unk02);
            Tools.WriteInt(fs, (int)talk.unk03);                        //10
            Tools.WriteInt(fs, (int)talk.unk04);
            Tools.WriteInt(fs, NodeList.Count);//Data1Count = Tools.ReadInt(s);
            Tools.WriteInt(fs, 0x38);//Data1Offset = Tools.ReadInt(s);
            Tools.WriteInt(fs, StringList.Count);//Data2Count = Tools.ReadInt(s);      //20
            Tools.WriteInt(fs, 0x38 + NodeList.Count * 4);//Data2Offset = Tools.ReadInt(s);
            Tools.WriteInt(fs, 0);//Data3Count = Tools.ReadInt(s);
            Tools.WriteInt(fs, 0x38 + NodeList.Count * 4 + StringList.Count * 8);//Data3Offset = Tools.ReadInt(s);
            Tools.WriteInt(fs, 0);//Data4Count = Tools.ReadInt(s);      //30
            Tools.WriteInt(fs, 0x38 + NodeList.Count * 4 + StringList.Count * 8);//Data4Offset = Tools.ReadInt(s);
            foreach (int i in NodeList)
                Tools.WriteInt(fs, i);
            foreach (StringID sid in StringList)
            {
                Tools.WriteInt(fs, (int)sid.ID);
                Tools.WriteInt(fs, (int)sid.offset);
            }
